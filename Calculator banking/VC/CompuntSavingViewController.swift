//
//  CompuntSavingViewController.swift
//  Calculator banking
//
...
class CompuntSavingViewController:  UIViewController {
...
//        
    ...
    @objc private func onCalculate(_ sender: UIButton) {
        ...
        if userfield1.checkIfEmpty() == true && userfield2.checkIfEmpty() == false && userfield3.checkIfEmpty() == false && userfield4.checkIfEmpty() == false {
            
            compoundSavings.futureValue = Double(userfield2.text!)!
            compoundSavings.interest = Double(userfield3.text!)!
            compoundSavings.numberOfYears = Double(userfield4.text!)!
            
            userfield1.text = String(compoundSavings.calculatePresentValue())
            
        } else if userfield1.checkIfEmpty() == false && userfield2.checkIfEmpty() == true && userfield3.checkIfEmpty() == false && userfield4.checkIfEmpty() == false {
            
            compoundSavings.presentValue = Double(userfield1.text!)!
            compoundSavings.interest = Double(userfield3.text!)!
            compoundSavings.numberOfYears = Double(userfield4.text!)!
            
            userfield2.text = String(compoundSavings.calculateFutureValue())
            
        } else if userfield1.checkIfEmpty() == false && userfield2.checkIfEmpty() == false && userfield3.checkIfEmpty() == true && userfield4.checkIfEmpty() == false {
            
            compoundSavings.presentValue = Double(userfield1.text!)!
            compoundSavings.futureValue = Double(userfield2.text!)!
            compoundSavings.numberOfYears = Double(userfield4.text!)!
            
            userfield3.text = String(compoundSavings.calculateCompoundInterestRate())
            
        } else if userfield1.checkIfEmpty() == false && userfield2.checkIfEmpty() == false && userfield3.checkIfEmpty() == false && userfield4.checkIfEmpty() == true {
            
            compoundSavings.presentValue = Double(userfield1.text!)!
            compoundSavings.futureValue = Double(userfield2.text!)!
            compoundSavings.interest = Double(userfield3.text!)!
            
            userfield4.text = String(compoundSavings.calculateNumberOfYears())
